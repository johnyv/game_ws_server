...
import taurus.http.client.HttpClientPool;
...
public class HttpUtil {
    ...
    public synchronized static NioEventLoopGroup getBossEventLoopGroup() {
        if (bossEventLoopGroup == null) {
            bossEventLoopGroup = new NioEventLoopGroup(2, Executors.newFixedThreadPool(2, new DefaultThreadFactory("handler-boss-default", true)));
        }
    ...
    public synchronized static NioEventLoopGroup getWorkerEventLoopGroup() {
        if (workerEventLoopGroup == null) {
            workerEventLoopGroup = new NioEventLoopGroup(4, Executors.newFixedThreadPool(4, new DefaultThreadFactory("handler-worker-default", true)));
        }
    ...
    public static NioEventLoopGroup getRequestEventLoopGroup() {
        if (requestEventLoopGroup == null) {
            requestEventLoopGroup = new NioEventLoopGroup(2, Executors.newFixedThreadPool(2, new DefaultThreadFactory("handler-request-default", true)));
        }
