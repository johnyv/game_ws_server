...
public class WebSocketServerChannelInitializer extends ChannelInitializer<SocketChannel> {
    ...
    protected void initChannel(SocketChannel ch) throws Exception {
        ...
        pipeline.addLast("handler-codec", new HttpServerCodec());
        pipeline.addLast("aggregator", new HttpObjectAggregator(1024 * 1024 * 2));
        pipeline.addLast("handler-chunked", new ChunkedWriteHandler());
